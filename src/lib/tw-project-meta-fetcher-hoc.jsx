...
export const fetchProjectMeta = async projectId => {
    const urls = [
        `https://trampoline.rCodenow.org/api/projects/${projectId}`,
        `https://trampoline.rCodenow.xyz/api/projects/${projectId}`
    ];
    let firstError;
        ...
        componentDidUpdate () {
            ...
            fetchProjectMeta(projectId)
                .then(data => {
                    ...
                    const authorThumbnail = `https://trampoline.rCodenow.org/avatars/${data.author.id}`;
