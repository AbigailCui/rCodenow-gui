...
const isTrustedExtension = url => (
    ...
    // For rCodenow.
    url.startsWith('data:') || url.startsWith('https://0832k12.github.io/') || url.startsWith('https://extension.turbowarp.cn/') ||
...
const isAlwaysTrustedForFetching = parsed => (
    ...
    parsed.origin === 'https://rCodenow.org' ||
    parsed.origin.endsWith('.rCodenow.org') ||
    parsed.origin.endsWith('.rCodenow.xyz') ||
