        ...
        <div className={styles.footerContent}>
            <div className={styles.footerText}>
                <FormattedMessage
                    ...
                    description="Disclaimer that rCodenow is not connected to Scratch"
            ...
            <div className={styles.footerColumns}>
                <div className={styles.footerSection}>
                    ...
                    <a href="https://github.com/sponsors/0832k12">
                        <FormattedMessage
                ...
                <div className={styles.footerSection}>
                    <a href="https://desktop.rCodenow.cn/rCodenow/">
                        {/* Do not translate */}
                        {'rCodenow Desktop'}
                    </a>
                    <a href="https://packager.40code.com/">
                        {/* Do not translate */}
                        {'40code Packager'}
                    </a>
                    <a href="https://docs.rCodenow.cn/embedding">
                        <FormattedMessage
                    ...
                    <a href="https://docs.rCodenow.cn/url-parameters">
                        <FormattedMessage
                ...
                <div className={styles.footerSection}>
                    <a href="https://0832k12.github.io/rxly">
                        <FormattedMessage
                    ...
                    <a href="https://github.com/0832k12/rcodenow-gui/">
                        <FormattedMessage
...
class Interface extends React.Component {
    ...
    handleUpdateProjectTitle(title, isDefault) {
        if (isDefault || !title) {
            document.title = `rCodenow`;
        } else {
            document.title = `${title} - rCodenow`;
        }
    }
    render() {
        const {
